...
const StoreSidebar = ({storeInfo}) => {
    ...
    const sidebarLinks = [
        { name: 'Painel', href: '/store', icon: HomeIcon },
        { name: 'Adicionar Produto', href: '/store/add-product', icon: SquarePlusIcon },
        { name: 'Gerenciar Produto', href: '/store/manage-product', icon: SquarePenIcon },
