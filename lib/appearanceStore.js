...
=======
    ...
    { name: 'Raleway',      label: 'Raleway',        sample: 'Elegante e sofisticado' },
    { name: 'Montserrat',   label: 'Montserrat',     sample: 'Forte e editorial' },
    { name: 'Merriweather', label: 'Merriweather',   sample: 'Clássico e confiável' },
...
<<<<<<< HEAD
    ...
    heroCardLink1: 'Ver mais',
    heroCardTitle2: '20% de desconto',
    heroCardLink2: 'Ver mais',
=======
    // Identidade da loja
    storeName:         'INOVE-DEV',
    storeSlogan:       'Shop smarter.',
    ...
    // Hero — imagens (null = usar imagem padrão dos assets)
    heroImage:         null,
    heroCard1Image:    null,
    heroCard2Image:    null,
>>>>>>> 9ac4293b5f04c3f0d36855030fe94f53feebe516
...
// ── Aplicar preset de negócio de uma vez ──────────────────────────────────────
export function applyPreset(preset) {
    const newAppearance = { ...defaultAppearance, ...preset.appearance }
    const newTheme      = { ...defaultTheme,      ...preset.theme }
    localStorage.setItem(APPEARANCE_KEY, JSON.stringify(newAppearance))
    saveTheme(newTheme)
    applyFont(newAppearance.fontFamily)
    window.dispatchEvent(new Event('storage'))
    return { appearance: newAppearance, theme: newTheme }
}
