        ...
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full rounded-3xl p-6 px-8 group overflow-hidden' style={{ backgroundColor: theme.card2Bg || '#fed7aa' }}>
                        <div>
                    ...
                    <div className='flex-1 flex items-center justify-between w-full rounded-3xl p-6 px-8 group overflow-hidden' style={{ backgroundColor: theme.card3Bg || '#bfdbfe' }}>
                        <div>
