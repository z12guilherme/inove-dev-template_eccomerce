...
describe('ThemeProvider — applyTheme', () => {
    it('define todas as custom properties', () => {
        ...
        expect(setPropertyMock).toHaveBeenCalledWith('--font-primary', `"${defaultTheme.fontPrimary}", sans-serif`);
        expect(setPropertyMock).toHaveBeenCalledWith('--radius-global', defaultTheme.borderRadius);
    });
});
